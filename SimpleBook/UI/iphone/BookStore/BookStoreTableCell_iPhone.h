...
@class BookStoreTableCell_iPhone;
// cell 中的功能按钮被按下时, 触发的处理块
typedef void (^BookStoreTableCellFunctionButtonClickHandleBlock)(BookStoreTableCell_iPhone* tableCell, NSString *contentIDString);

@class LocalBook;
@interface BookStoreTableCell_iPhone : PRPNibBasedTableViewCell
