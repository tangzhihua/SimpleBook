...
@interface BookStoreTableCell_iPhone ()
...
@implementation BookStoreTableCell_iPhone
...
+(void) initialize {
  ...
  if (self == [BookStoreTableCell_iPhone class]) {
    
    kButtonDefaultBGImageOfBlank = [UIImage imageNamed:@"k_iphone"];
    kButtonHighlightedBGImageOfBlank = [UIImage imageNamed:@"k_touch_iphone"];
    kButtonDefaultBGImageOfDownload = [UIImage imageNamed:@"xz_iphone"];
    kButtonHighlightedBGImageOfDownload = [UIImage imageNamed:@"xz_touch_iphone"];
    kButtonDefaultBGImageOfPause = [UIImage imageNamed:@"zt_iphone"];
    kButtonHighlightedBGImageOfPause = [UIImage imageNamed:@"zt_touch_iphone"];
    kButtonDefaultBGImageOfInstalled = [UIImage imageNamed:@"yd_iphone"];
    kButtonHighlightedBGImageOfInstalled = [UIImage imageNamed:@"yd_touch_iphone"];
  }
}
